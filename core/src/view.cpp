...
bool View::pointer_down(double x, double y, bool mouse) {
  ...
  // A Slider takes the pointer FIRST: the gesture starts on the press (the thumb
  // jumps to the finger), and the control lives inside scrollable screens where
  // the drag has to move the value and not the list. G11 (ZAB-144) puts the text
  // field here too, for the same reason.
