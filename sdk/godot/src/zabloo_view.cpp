...
void ZablooView::_unhandled_key_input(const Ref<InputEvent> &event) {
  ...
  switch (key->get_keycode()) {
    case KEY_LEFT: changed = pressed && view->move_focus(-1, 0); break;
    case KEY_RIGHT: changed = pressed && view->move_focus(1, 0); break;
    case KEY_UP: changed = pressed && view->move_focus(0, -1); break;
    case KEY_DOWN: changed = pressed && view->move_focus(0, 1); break;
    case KEY_ENTER:
    case KEY_KP_ENTER:
    case KEY_SPACE:
